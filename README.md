...
## Deck structure
![Deck structure](img/deck-order.png)

## Anki Settings
### Preferences
![Anki_Review_Preferences](img/anki-reviews-preferences.png)

### Add-ons
![Anki_AddOns-List](img/anki-add-ons-list.png)
...
## Deck Settings
### Scheduling
![Scheduling daily](img/anki-daily-limits.png)
![Scheduling new](img/anki-new-cards.png)
![Scheduling lapses](img/anki-lapses.png)
![Scheduling_display_order](img/anki-display-order.png)

### Burying, Timer, Audio
![Scheduling timer](img/anki-timer.png)
![Scheduling burying](img/anki-burying.png)
![Scheduling audio](img/anki-audio.png)

### Advanced
![Scheduling timer](img/anki-advanced.png)
